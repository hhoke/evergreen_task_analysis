...
<iframe id="HostTerminations" scrolling="no" style="border:none;" seamless="seamless" src="https://evergreen-task-analysis.s3.us-east-2.amazonaws.com/reapingExample.html"></iframe>

See if you can guess when the hosts were reaped just by looking at the gantt chart above! Answer hidden below:

<details>
  <summary>Reaping times</summary>
  1:05AM and 2:00 AM 
</details>
